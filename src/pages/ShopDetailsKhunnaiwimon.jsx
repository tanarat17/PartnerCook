...
function ShopDetailsKhunnaiwimon() {
  return (
    <>
      <Header />
      <Container maxWidth="sm" className="mt-7">
        <Box sx={{ bgcolor: "#AFEA3D" }} className="h-3/5 w-full mb-10 ">
          <p className="text-3xl text-center pt-10">ร้านผักคุณนายวิมล</p>
          <div className="flex justify-center my-10">
            <NavLink to="/choose/wimon">
...
export default ShopDetailsKhunnaiwimon;
