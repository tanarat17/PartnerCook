...
export default function MapKhunnaiWimon() {
    const markerIcon = new L.Icon({
        iconUrl: "https://cdn.pixabay.com/photo/2014/04/03/10/03/google-309740_1280.png",
        iconSize: [35,35],
    });
    const position = [13.90661863070067, 100.52568870594502]
  return (
    <div style={{ width: '100%', height: '100%', aspectRatio: 0.5}}>
      ...
      <MapContainer style={{width: '100%', height: '100%'}} center={position} zoom={13} scrollWheelZoom={false}>
        ...
        />
        <Marker position={[13.90661863070067, 100.52568870594502]} icon={markerIcon}>
          <Popup>
            ร้านผักคุณนายวิมล
          </Popup>
        </Marker>
